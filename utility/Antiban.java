package scripts.dmmrelekkafisher.utility;
...
public class Antiban {
    ...
    */
     ...
     */
    public RSNPC getNextTarget(Positionable[]targets) {
    ...
    public void executeShouldMoveToAnticipated(){
        // ADD STUFF INf HERE BASED ON THE SCRIPT.
    }
    ...
    public void sleepReactionTime(int waitingTime){
        try {
            ...
            System.out.println("Antiban - Reaction Times: sleepReactionTime initiated. Sleeping for: " + sleepTime +
                    " milliseconds");
